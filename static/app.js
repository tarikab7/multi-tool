...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const savedTheme = localStorage.getItem("multitool-theme") || localStorage.getItem("antigravity-theme") || "purple";
    ...
    let favorites = JSON.parse(localStorage.getItem("multitool-favorites") || localStorage.getItem("antigravity-favorites") || "[]");
    ...
    function toggleFavorite(tool, starBtn) {
        ...
        localStorage.setItem("multitool-favorites", JSON.stringify(favorites));
    ...
    if (btnDownloadLogs) {
        btnDownloadLogs.addEventListener("click", () => {
            ...
            a.href = url;
            a.download = `multitool_execution_logs_${new Date().toISOString().slice(0,19).replace(/[:T]/g,"-")}.txt`;
